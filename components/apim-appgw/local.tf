locals {
  env = var.env == "perftest" ? "test" : var.env

  vnet_rg     = var.env == "ithc" || var.env == "perftest" || var.env == "demo" ? "hmcts-hub-nonprodi" : "hmcts-hub-${var.env}-int"
  vnet_name   = var.env == "ithc" || var.env == "perftest" || var.env == "demo" ? "hmcts-hub-nonprodi" : "hmcts-hub-${var.env}-int"
