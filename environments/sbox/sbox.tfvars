...
cft_apps_cluster_ips            = ["10.2.11.250", "10.2.9.250"]
...
frontends = [
  ...
  },
  {
    ...
    dns_zone_name    = "sandbox.platform.hmcts.net"
    backend_domain   = ["lb-sbox-int-plum.uksouth.cloudapp.azure.com", "firewall-sbox-int-palo-sbox.uksouth.cloudapp.azure.com"]
    certificate_name = "wildcard-sandbox-platform-hmcts-net"
    disabled_rules   = {}
    shutter_app      = true
  },
